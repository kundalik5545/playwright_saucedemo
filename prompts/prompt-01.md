...
- While creating test script, always use page objects and always use data from json files.
- Always add comments to the code to explain what the code is doing.
- Always add proper logging to the code to track the execution flow.
- Always add proper error handling to the code to handle any unexpected errors.
- Always add proper cleanup to the code to close the browser and driver after the test execution.
